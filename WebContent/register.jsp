		...
		<div class="container">
			<div  class="form-outer text-center d-flex align-items-center">
				...
				:1500px;" class="form-inner">
					...
					<form  action="Register" method="post" class="text-left form-validate">
						...
						<div class="form-group-material">
							<input id="login-username" type="text" name="github"
								required data-msg="Veuillez saisir votre compte Github"
								class="input-material"> <label for="login-username"
								class="label-material">Lien du compte Github</label>
						</div>
						<div class="form-group-material">
					...
					<a style="font-size: 15px;" class="forgot-pass" href="loginChefProjet.jsp">Do You
