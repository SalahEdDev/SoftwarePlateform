			...
			<div id="contact" class="container">
				...
				<div class="row">
					...
					<div class="col-md-8 mx-auto">
						<form action="DemandeMaintenanceServlet" method="post" enctype="multipart/form-data">
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label for="subject">Sujet</label> <input id="subject"
											type="text" name="sujet" class="form-control">
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label for="observation_complementaire">Observations complémentaires</label> <input id="observation_complementaire"
											type="text" name="observation_complementaire" class="form-control">
									</div>
								</div>
								<div class="col-sm-12 text-center">
									<button type="submit" class="btn btn-template-outlined">
										<i class="fa fa-envelope-o"></i> Envoyer votre Demande
									</button>
								</div>
							</div>
						</form>
