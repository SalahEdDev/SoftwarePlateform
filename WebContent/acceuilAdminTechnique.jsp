                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      <thead>
                        <tr>
                          <th style="text-align:center;">Voir les demandes</th>
                          <th style="text-align:center;">Voir les logiciels</th>
                          <th style="text-align:center;">Voir les chefs de projet</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
							<td style="text-align:center;"><a href="DemandeMaintenanceServlet">Demandes de Maintenance</a>&nbsp;/&nbsp;<a href="DemandeAdapteeServlet">Demandes Adaptées</a></td> 
							<td style="text-align:center;"><a href="ajouterLogiciel.jsp">Ajouter des logiciels</a>&nbsp;/&nbsp;<a href="AjouterLogicielServlet">Liste des logiciels</a></td> 
							<td style="text-align:center;"><a href="ChefDeProjetServlet">Chefs de projet</a></td> 
                      </tr>
                      </tbody>
                    </table>
                  </div>
