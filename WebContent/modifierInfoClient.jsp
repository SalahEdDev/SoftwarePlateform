				...
				<div class="row">
					...
					<div class="col-md-8 mx-auto">
					   <c:forEach items="${clients}" var="row" >
						<form action="ModifierInfoClient" method="post">
							<div class="row">
							   <input type="text" id="inputDisabledEx2" name="id" value="<%= session.getAttribute("id") %>" class="form-control" hidden>
								<div class="col-sm-12">
									<div class="form-group">
										<label for="nom"></label> <input type="text" id="inputDisabledEx2" name="nom" value=<c:out value="${row.getNomCLT()}"/> class="form-control" hidden>
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
										<label for="prenom"></label> <input type="text" id="inputDisabledEx6" name="prenom" value=<c:out value="${row.getPrenomCLT()}"/> class="form-control" hidden>
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
										<label for="email">Email client</label> <input type="email" id="inputDisabledEx7" name="email" value=<c:out value="${row.getEmailCLT()}"/> class="form-control">
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
										<label for="password">Password client</label> <input type="password" id="inputDisabledEx8" name="password" value=<c:out value="${row.getPasswordCLT()}"/> class="form-control" >
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
										<label for="adressse">Adresse client</label> <input type="text" id="inputDisabledEx9" name="adresse" value=<c:out value="${row.getAdresseCLT()}"/> class="form-control" >
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
										<label for="cin"></label> <input type="text" id="inputDisabledEx9" name="cin" value=<c:out value="${row.getCinCLT()}"/> class="form-control" hidden>
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
										<label for="tel">Numéro de téléphone client</label> <input type="text" id="inputDisabledEx10" name="tel" value=<c:out value="${row.getNum_telephoneCLT()}"/> class="form-control" >
									</div>
								</div>
								<!-- <div class="col-sm-12 text-center">
									<a class="form-control" style="color:green" href="ModifierInfoClient?id=<%= session.getAttribute("id") %>&type=a">Mise à jour de vos informations</a>
								</div> -->
								<div class="col-sm-12 text-center">
